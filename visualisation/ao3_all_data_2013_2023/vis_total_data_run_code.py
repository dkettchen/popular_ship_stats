...
total_gender_percent_fig = visualise_stacked_bars(total_gender_percentages, "gender_combos", "total")
...
minority_gender_combos_fig = visualise_stacked_bars(total_gender_percentages, "minority_gender_combos", "total")
