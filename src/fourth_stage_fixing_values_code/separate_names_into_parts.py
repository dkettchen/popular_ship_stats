...
if __name__ == "__main__":
    ...
    with open("data/reference_and_test_files/cleaning_characters/full_characters_list.json", "w") as file:
    ...
    with open("data/reference_and_test_files/cleaning_characters/cleaned_characters_list_1_no_brackets.json", "w") as file:
        dump(character_dict, file, indent=4)
    ...
    with open("data/reference_and_test_files/cleaning_characters/cleaned_characters_list_2_split_names.json", "w") as file:
        dump(character_dict, file, indent=4)